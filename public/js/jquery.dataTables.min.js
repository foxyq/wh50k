...
oPaginate:{sFirst:"Prvá",sLast:"Posledná",sNext:"Ďalšia",sPrevious:"Predchádzajúca"},sEmptyTable:"Žiadne data v tabuľke",sInfo:"Zobrazených _START_ až _END_ z _TOTAL_ záznamov",sInfoEmpty:"Zobrazených 0 až 0 z 0 záznamov",sInfoFiltered:"(vyfiltrovaných z _MAX_ všetkých záznamov)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Zobraziť _MENU_ záznamov",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Vyhľadať:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Ľutujem, nič také sme nenašli"},oSearch:h.extend({},
